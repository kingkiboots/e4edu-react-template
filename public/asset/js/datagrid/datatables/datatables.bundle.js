...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		 ...
		 *    } )
		 */
		"iDisplayLength": 15,/************************************************** 데이타 테이블 목록 기본 수 **************************************************/
...
$.extend(true, $.fn.dataTableExt.oStdClasses, {
	"sFilterInput": "form-control form-control-sm border-top-left-radius-0 border-bottom-left-radius-0 ml-0 width-lg shadow-inset-1",
	"sLengthSelect": "form-control custom-select custom-select-sm"
});	
...
$.extend(true, $.fn.dataTable.defaults, {
	/*	--- Layout Structure 
		...
		--------------------------------------
	*/
	dom:/*"<'row mb-1'<'col-sm-12 col-md-6 d-flex align-items-center justify-content-start'f><'col-sm-12 col-md-6 d-flex align-items-center justify-content-end'l>>" +*//************************** 검색창 페이지 **************************/
        /*"<'row mb-1'<'col-sm-12 col-md-12 d-flex align-items-center justify-content-end'l>>" +*//************************** 검색창 페이지 **************************/
		"<'row'<'col-sm-12'tr>>" +
		"<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",
